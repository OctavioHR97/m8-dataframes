...
salary.57 <- salaries[57,'salaries.2015']

# How many employees got a raise?
raise.num <- nrow(salaries[salaries$got.raise == TRUE,])

# What was the value of the highest raise?
highest.raise <- salaries[salaries$raise == max(salaries$raise),]
